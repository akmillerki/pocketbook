...
def home(request):
    ...
    test = "test"
    context = {'test': test}
    return render(request, 'rezsched/home.html', context)
...
def rotationbyblock(request, pk):
    ...
    if request.method == "POST":
        if 'add_line' in request.POST:
            ...
            if formset.is_valid:
                formset.save()
                return render_to_response("rezsched/rotation_schedule_block.html", {
            ...
            return render_to_response("rezsched/rotationschedule_list.html", {
...
def rotationlistrotation(request):
    ...
    return render_to_response("rezsched/rotationschedule_rotation_list.html", {
...
def clinicavailabilitylistrotation(request):
    ...
    userOrgYear = UserOrganizationYear.get(uoy)
    rotationset = Rotation.objects.filter(organization__exact=userOrg, organizationYear__exact=userOrgYear)
    return render_to_response("rezsched/clinicavailability_rotation_list.html", {
        "rotationset": rotationset}, context_instance=RequestContext(request)
    )
...
def cliniccountlist(request):
    ...
    userOrgYear = UserOrganizationYear.get(uoy)
    blockset = Block.objects.filter(organization__exact=userOrg, organizationYear__exact=userOrgYear)
    return render_to_response("rezsched/clinic_count_list.html", {
        "blockset": blockset}, context_instance=RequestContext(request)
    )
...
def rotationlistresident(request):
    ...
    return render_to_response("rezsched/rotationschedule_resident_list.html", {
...
def facultyroundinglist(request):
    ...
    return render_to_response("rezsched/facultyrounding_list.html", {
...
def residentcustom(request):
    ...
    if request.method == "POST":
        ...
        if formset.is_valid():
            ...
            return render_to_response("rezsched/resident_custom.html", {
...
def facultyleavelist(request):
    ...
    return render_to_response("rezsched/faculty_leave_list.html", {
...
def residentleavelist(request):
    ...
    userOrgYear = UserOrganizationYear.get(uoy)
    residentset = Resident.objects.filter(organization__exact=userOrg, organizationYear__exact=userOrgYear)
    return render_to_response("rezsched/resident_leave_list.html", {
        "residentset": residentset}, context_instance=RequestContext(request)
    )
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            if formset.is_valid():
                ...
                # change to error response
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/faculty_leave.html", {
                    "formset": formset, "dispContext": dispContext, "dispSaveError": dispSaveError}, context_instance=RequestContext(request)
                )
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            if formset.is_valid():
                ...
                # change to error response
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/resident_leave.html", {
                    "formset": formset, "dispContext": dispContext, "dispSaveError": dispSaveError}, context_instance=RequestContext(request)
                )
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            if formset.is_valid():
                ...
                # change to error response
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/clinic_count.html", {
                    "formset": formset, "dispContext": dispContext, "dispSaveError": dispSaveError}, context_instance=RequestContext(request)
                )
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            if formset.is_valid() and cacFormSet.is_valid():
                ...
                # change to error response
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/clinicavailability_rotation.html", {
...
def blocktyperedirect(request):
    ...
    return render_to_response("rezsched/orgyear_rotation.html", {
        "formset": formset,
        })
...
def blockcustom(request):
    ...
    return render(request, 'rezsched/block_custom.html', context)
...
def rotationtypelist(request):
    ...
    userOrgYear = UserOrganizationYear.get(uoy)
    rotationset = Rotation.objects.filter(organization__exact=userOrg, organizationYear__exact=userOrgYear)
    return render_to_response("rezsched/rotation_type_list.html", {
        "rotationset": rotationset}, context_instance=RequestContext(request)
    )
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            if formset.is_valid() and rotFormset.is_valid():
                ...
                # change to error response
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/rotation_type.html", {
...
def blocktypelist(request):
    ...
    userOrgYear = UserOrganizationYear.get(uoy)
    blockset = Block.objects.filter(organization__exact=userOrg, organizationYear__exact=userOrgYear)
    return render_to_response("rezsched/block_type_list.html", {
        "blockset": blockset}, context_instance=RequestContext(request)
    )
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            if formset.is_valid() and blkFormset.is_valid():
                ...
                # change to error response
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/block_type.html", {
...
def rotationcustom(request):
    ...
    return render(request, 'rezsched/rotation_custom.html', context)
...
def officehourscustom(request):
    ...
    return render(request, 'rezsched/officehours_custom.html', context)
...
def holidaycustom(request):
    ...
    return render(request, 'rezsched/holiday_custom.html', context)
...
def unavailabletypecustom(request):
    ...
    return render(request, 'rezsched/unavailabletype_custom.html', context)
...
def clinicavailabilitycustom(request):
    ...
    return render(request, 'rezsched/clinicavailability_custom.html', context)
...
def generateschedule(request):
    ...
    #context = {'items': items}
    #return render(request, 'rezsched/generateSchedules.html', context)
        ...
        if 'submit' in request.POST:
            ...
            for w in arrayWeeks:
                if workingSet > 0:
                    ...
                    return render_to_response('rezsched/clinic_schedule_run.html', {
                    ...
                    if int(cpWeekId) != 5:
                        ...
                        return render(request, 'rezsched/reviewSchedules.html', context)
...
def orgyearschedulesetup(request):
    ...
    if request.method == 'POST':
        ...
        if formset.is_valid():
            formset.save()
            return render_to_response(request, 'rezsched/sched_setup.html', {
                "formset": formset
                }, RequestContext(request))
    else:
        formset = BlockFormSet()
        return render_to_response('rezsched/sched_setup.html', {
        })
    #context = {'schedBlocks': dto}
    #return render(request, 'rezsched/sched_setup.html', context)
...
def orgyearrotationsetup(request):
    ...
    return render(request, 'rezsched/rotation_setup.html', context)
...
def orgyearsessionsetup(request):
    ...
    return render(request, 'rezsched/session_setup.html', context)
...
def orgyearteamsetup(request):
    ...
    return render(request, 'rezsched/team_setup.html', context)
...
def orgyearleavesetup(request):
    ...
    return render(request, 'rezsched/leave_setup.html', context)
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            if formset.is_valid():
                ...
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/rotation_schedule_resident.html", {
                    "formset": formset, "dispContext": dispContext, "dispSaveError": dispSaveError}, context_instance=RequestContext(request)
                )
    else:
...
def reviewschedulebyblockweek(request):
    ...
    if request.method == 'POST':
        ...
        return render_to_response('rezsched/review_schedule_run.html', {
...
def facultyclinichours(request, pk):
    ...
    if request.method == "POST":
        if 'cancel' in request.POST:
            ...
            userOrgYear = UserOrganizationYear.get(uoy)
            facultyset = Faculty.objects.filter(organization__exact=userOrg, organizationYear__exact=userOrgYear)
            return render_to_response("rezsched/facultyclinichours_list.html", {
                "facultyset": facultyset}, context_instance=RequestContext(request)
            )
            ...
            if formset.is_valid():
                ...
                # change to error response
                dispSaveError = 'One or more required fields are missing, please re-enter your data or select cancel.'
                return render_to_response("rezsched/facultyclinichours.html", {
