var ie_png = {
	...
	createVmlStyleSheet: function() { /* style VML, enable behaviors */
		/*
			...
			further reading: static://msdn.microsoft.com/en-us/library/ms531194(VS.85).aspx
		*/
		...
		styleSheet.addRule('img.' + this.ns + '_sizeFinder', 'behavior:none; border:none; position:absolute; z-index:-1; top:-10000px; visibility:hidden;'); /* large negative top value for avoiding vertical scrollbars for large images, suggested by James O'Brien, static://www.thanatopsic.org/hendrik/ */
